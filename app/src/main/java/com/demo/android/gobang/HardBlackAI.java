...
public class HardBlackAI {
    ...
    private int h(int[][] A) {
        boolean three = false, four = false; //防止出现“三”，“四”局面
        int value = 0;
        int[][] tmp = new int[15][15];
        mcopy(tmp, A);
        //棋谱1：四子连线，端点都在
        for(int i = 0; i < 15; i++) { //水平方向
            for(int j = 0; j < 10; j++) {
                ...
                if(tmp[i][j]+tmp[i][5]!=4&&tmp[i][j+1]==mBlack&&tmp[i][j+2]==mBlack
                        &&tmp[i][j+3]==mBlack&&tmp[i][j+4]==mBlack) {
                    four = true;
                }

                if(tmp[i][j]+tmp[i][j+5]!=2&&tmp[i][j+1]==mWhite&&tmp[i][j+2]==0
                        &&tmp[i][j+3]==mWhite&&tmp[i][j+4]==mWhite) {
                    value += 100;
                }
                if(tmp[i][j]+tmp[i][j+5]!=2&&tmp[i][j+1]==mWhite&&tmp[i][j+2]==mWhite
                        &&tmp[i][j+3]==0&&tmp[i][j+4]==mWhite) {
                    value += 100;
                }
                if(tmp[i][j]!=mWhite&&tmp[i][j+1]==mBlack&&tmp[i][j+2]==0
                        &&tmp[i][j+3]==mBlack&&tmp[i][j+4]==mBlack&&tmp[i][j+5]!=mWhite) {
                    value += -100;
                }
                if(tmp[i][j]!=mWhite&&tmp[i][j+1]==mBlack&&tmp[i][j+2]==mBlack
                        &&tmp[i][j+3]==0&&tmp[i][j+4]==mBlack&&tmp[i][j+5]!=mWhite) {
                    value += -100;
                }
            }
        }
        for(int i = 0; i < 10; i++) { //垂直方向
            for(int j = 0; j < 15; j++) {
                ...
                if(tmp[i][j]+tmp[i+5][j]!=2&&tmp[i+1][j]==mWhite&&tmp[i+2][j]==0
                        &&tmp[i+3][j]==mWhite&&tmp[i+4][j]==mWhite) {
                    value += 100;
                }
                if(tmp[i][j]+tmp[i+5][j]!=2&&tmp[i+1][j]==mWhite&&tmp[i+2][j]==mWhite
                        &&tmp[i+3][j]==0&&tmp[i+4][j]==mWhite) {
                    value += 100;
                }
                if(tmp[i][j]!=mWhite&&tmp[i+1][j]==mBlack&&tmp[i+2][j]==0
                        &&tmp[i+3][j]==mBlack&&tmp[i+4][j]==mBlack&&tmp[i+5][j]!=mWhite) {
                    value += -100;
                }
                if(tmp[i][j]!=mWhite&&tmp[i+1][j]==mBlack&&tmp[i+2][j]==mBlack
                        &&tmp[i+3][j]==0&&tmp[i+4][j]==mBlack&&tmp[i+5][j]!=mWhite) {
                    value += -100;
                }
            }
        }
        for(int i = 0; i < 10; i++) { //正斜方向
            for(int j = 0; j < 10; j++) {
                ...
                if(tmp[i][j]+tmp[i+5][j+5]!=2&&tmp[i+1][j+1]==mWhite&&tmp[i+2][j+2]==0
                        &&tmp[i+3][j+3]==mWhite&&tmp[i+4][j+4]==mWhite) {
                    value += 100;
                }
                if(tmp[i][j]+tmp[i+5][j+5]!=2&&tmp[i+1][j+1]==mWhite&&tmp[i+2][j+2]==mWhite
                        &&tmp[i+3][j+3]==0&&tmp[i+4][j+4]==mWhite) {
                    value += 100;
                }
                if(tmp[i][j]!=mWhite&&tmp[i+1][j+1]==mBlack&&tmp[i+2][j+2]==0
                        &&tmp[i+3][j+3]==mBlack&&tmp[i+4][j+4]==mBlack&&tmp[i+5][j+5]!=mWhite) {
                    value += -100;
                }
                if(tmp[i][j]!=mWhite&&tmp[i+1][j+1]==mBlack&&tmp[i+2][j+2]==mBlack
                        &&tmp[i+3][j+3]==0&&tmp[i+4][j+4]==mBlack&&tmp[i+5][j+5]!=mWhite) {
                    value += -100;
                }
            }
        }
    ...
    private int h1(int[][] A) {
        ...
        for(int i = 1; i <= 13; i++){
            for(int j = 1; j <= 13; j++) {
                if(tmp[i][j] == mWhite) {
                    if (i <= 10) { //水平方向四子
                        if (tmp[i - 1][j] + tmp[i + 4][j] != 2 && tmp[i][j] == mWhite && tmp[i + 1][j] == mWhite
                                && tmp[i + 2][j] == mWhite && tmp[i + 3][j] == mWhite) {
                            value += 20000;
                        }

                        if (tmp[i - 1][j] + tmp[i + 4][j] != 2 && tmp[i][j] == mWhite && tmp[i + 1][j] == 0
                                && tmp[i + 2][j] == mWhite && tmp[i + 3][j] == mWhite) {
                            value += 100;
                        }
                        if (tmp[i - 1][j] + tmp[i + 4][j] != 2 && tmp[i][j] == mWhite && tmp[i + 1][j] == mWhite
                                && tmp[i + 2][j] == 0 && tmp[i + 3][j] == mWhite) {
                            value += 100;
                        }
                    }
                    if (j <= 10) { //垂直方向四子
                        if (tmp[i][j - 1] + tmp[i][j + 4] != 2 && tmp[i][j] == mWhite && tmp[i][j + 1] == mWhite
                                && tmp[i][j + 2] == mWhite && tmp[i][j + 3] == mWhite) {
                            value += 20000;
                        }

                        if (tmp[i][j - 1] + tmp[i][j + 4] != 2 && tmp[i][j] == mWhite && tmp[i][j + 1] == 0
                                && tmp[i][j + 2] == mWhite && tmp[i][j + 3] == mWhite) {
                            value += 100;
                        }
                        if (tmp[i][j - 1] + tmp[i][j + 4] != 2 && tmp[i][j] == mWhite && tmp[i][j + 1] == mWhite
                                && tmp[i][j + 2] == 0 && tmp[i][j + 3] == mWhite) {
                            value += 100;
                        }
                    }
                    if (i <= 10 && j <= 10) { //正斜方向四子
                        if (tmp[i - 1][j - 1] + tmp[i + 4][j + 4] != 2 && tmp[i][j] == mWhite && tmp[i + 1][j + 1] == mWhite
                                && tmp[i + 2][j + 2] == mWhite && tmp[i + 3][j + 3] == mWhite) {
                            value += 20000;
                        }

                        if (tmp[i - 1][j - 1] + tmp[i + 4][j + 4] != 2 && tmp[i][j] == mWhite && tmp[i + 1][j + 1] == 0
                                && tmp[i + 2][j + 2] == mWhite && tmp[i + 3][j + 3] == mWhite) {
                            value += 100;
                        }
                        if (tmp[i - 1][j - 1] + tmp[i + 4][j + 4] != 2 && tmp[i][j] == mWhite && tmp[i + 1][j + 1] == mWhite
                                && tmp[i + 2][j + 2] == 0 && tmp[i + 3][j + 3] == mWhite) {
                            value += 100;
                        }
                    }
                    if (i >= 4 && j <= 10) { //反斜方向四子
                ...
                }else if(tmp[i][j] == mBlack) {
                    if(i <= 10) { //水平方向四子
                        if(tmp[i-1][j]!=mWhite&&tmp[i][j]==mBlack&&tmp[i+1][j]==mBlack
                                &&tmp[i+2][j]==mBlack&&tmp[i+3][j]==mBlack&&tmp[i+4][j]!=mWhite) {
                            value += -10000;
                        }

                        if(tmp[i-1][j]!=mWhite&&tmp[i][j]==mBlack&&tmp[i+1][j]==0
                                &&tmp[i+2][j]==mBlack&&tmp[i+3][j]==mBlack&&tmp[i+4][j]!=mWhite) {
                            value += -100;
                        }
                        if(tmp[i-1][j]!=mWhite&&tmp[i][j]==mBlack&&tmp[i+1][j]==mBlack
                                &&tmp[i+2][j]==0&&tmp[i+3][j]==mBlack&&tmp[i+4][j]!=mWhite) {
                            value += -100;
                        }
                    }
                    if(j <= 10) { //垂直方向四子
                        if(tmp[i][j-1]!=mWhite&&tmp[i][j]==mBlack&&tmp[i][j+1]==mBlack
                                &&tmp[i][j+2]==mBlack&&tmp[i][j+3]==mBlack&&tmp[i][j+4]!=mWhite) {
                            value += -10000;
                        }

                        if(tmp[i][j-1]!=mWhite&&tmp[i][j]==mBlack&&tmp[i][j+1]==0
                                &&tmp[i][j+2]==mBlack&&tmp[i][j+3]==mBlack&&tmp[i][j+4]!=mWhite) {
                            value += -100;
                        }
                        if(tmp[i][j-1]!=mWhite&&tmp[i][j]==mBlack&&tmp[i][j+1]==mBlack
                                &&tmp[i][j+2]==0&&tmp[i][j+3]==mBlack&&tmp[i][j+4]!=mWhite) {
                            value += -100;
                        }
                    }
                    if(i <= 10 && j <= 10) { //正斜方向四子
                        if(tmp[i-1][j-1]!=mWhite&&tmp[i][j]==mBlack&&tmp[i+1][j+1]==mBlack
                                &&tmp[i+2][j+2]==mBlack&&tmp[i+3][j+3]==mBlack&&tmp[i+4][j+4]!=mWhite) {
                            value += -10000;
                        }

                        if(tmp[i-1][j-1]!=mWhite&&tmp[i][j]==mBlack&&tmp[i+1][j+1]==0
                                &&tmp[i+2][j+2]==mBlack&&tmp[i+3][j+3]==mBlack&&tmp[i+4][j+4]!=mWhite) {
                            value += -100;
                        }
                        if(tmp[i-1][j-1]!=mWhite&&tmp[i][j]==mBlack&&tmp[i+1][j+1]==mBlack
                                &&tmp[i+2][j+2]==0&&tmp[i+3][j+3]==mBlack&&tmp[i+4][j+4]!=mWhite) {
                            value += -100;
                        }
                    }
                    if(i >= 4 && j <= 10) { //反斜方向四子
